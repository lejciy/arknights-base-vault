...
各 skill 由 84 题高频提问清单（`knowledge/bilibili_comments_questions_split.md`）逐类实测知识库回答路径后提炼：链路完整但环节多、单次检索容易断链的问题形态，固化为下面的必走步骤；知识库单点即可答好的问题不设 skill。
...
| [skill-5-报表对账与差异定位](skill-5-报表对账与差异定位.md) | 三日报表判读、实际与预期差额归因、工具预估与简报不一致 | 6、39、64、65、66、76、84 |
| [skill-6-边界识别与转介](skill-6-边界识别与转介.md) | 排班工具操作、MAA、账号与产品侧问题的拆分应答与转介 | 20、67、71、72、73、75、81、82、83 |
...
- 多个 skill 叠加时，执行顺序为：skill-1 → （2/3/4/5/7 按需）→ skill-6 兜底。
